...
export default function GlucoseTracker({
  ...
  return (
    <div className="mx-auto w-full max-w-2xl space-y-5">
      ...
      <section
        className={`rounded-3xl shadow-sm p-5 transition-colors ${statusCard[currentStatus]}`}
        aria-live="polite"
      >
        <div className="flex items-start justify-between">
          <div>
            ...
            <div className="flex items-baseline gap-2">
              ...
              {current && (
                <span className="text-4xl font-semibold" aria-label={current.direction}>
                  {trendArrow(current.direction)}
                </span>
              )}
            </div>
            <div className="text-sm opacity-90">{unitLabel(unit)}</div>
          </div>
          <div className="flex flex-col items-end gap-2">
            <button
              ...
              className="flex h-10 w-10 items-center justify-center rounded-full bg-black/10 hover:bg-black/20 active:scale-95 transition"
            >
        ...
        {isStale && (
          <div className="mt-3 flex items-center gap-2 rounded-xl bg-black/15 px-3 py-2 text-sm">
