...
const en: Dictionary = {
  ...
  nutritionUser: {
    ...
    barcodeNotFoundHint: "Check that the digits match the code printed on the package.",
    ...
    scannerTapFocus: "Tap to focus",
    scannerZoomLabel: "Zoom",
    scannerZoomIn: "Zoom in",
    scannerZoomOut: "Zoom out",
