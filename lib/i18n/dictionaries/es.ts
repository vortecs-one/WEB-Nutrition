...
const es = {
  ...
  nutritionUser: {
    ...
    barcodeNotFoundHint: "Comprueba que los dígitos coincidan con el código impreso en el envase.",
    ...
    scannerTapFocus: "Toca para enfocar",
    scannerZoomLabel: "Zoom",
    scannerZoomIn: "Acercar",
    scannerZoomOut: "Alejar",
  ...
  hydration: {
    ...
    liters: "L",
    ml: "ml",
    fullLiter: "litro completo",
    fullLiters: "litros completos",
    waterLiter: "litro de agua",
