...
const es = {
  ...
  nutritionUser: {
    ...
    // Food library
    foodLibrary: "Mis alimentos",
    foodLibrarySubtitle: "Alimentos guardados para registro rápido.",
    scanBarcode: "Escanear código",
    addFood: "Agregar alimento",
    saveToLibrary: "Guardar en mis alimentos",
    savedToLibrary: "Guardado en mis alimentos",
    addToMeal: "Agregar a comida",
    foodName: "Nombre del alimento",
    brand: "Marca (opcional)",
    barcode: "Código de barras",
    caloriesPer100g: "Calorías por 100 g",
    servingSize: "Porción (g)",
    fiberG: "Fibra (g)",
    sugarG: "Azúcar (g)",
    sodiumMg: "Sodio (mg)",
    searchFood: "Buscar en mis alimentos...",
    noFoods: "No tienes alimentos guardados.",
    scanHint: "Apunta la cámara al código de barras del producto.",
    scanError: "No se pudo leer el código. Intenta de nuevo.",
    scanLookingUp: "Buscando producto...",
    scanNotFound: "Producto no encontrado. Puedes registrarlo manualmente.",
    scanSuccess: "Producto encontrado",
    perServing: "por porción",
    per100g: "por 100 g",
    selectFromLibrary: "Seleccionar de mis alimentos",
    manualEntry: "Ingresar manualmente",
    scanTab: "Escanear",
    noMacros: "Sin datos de macros",
  },
  caloriesUser: {
    title: "Calorías",
